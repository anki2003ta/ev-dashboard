...
const Cafv = () => {
  ...
  return (
    <motion.div
      className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl py-6 px-4 sm:px-6 border border-gray-700"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.3 }}
    >
      <h2 className="text-lg font-medium mb-4 text-gray-100 text-center ">
	  Distribution of CAFV-eligible vehicles
      </h2>
      <div className="h-80">
